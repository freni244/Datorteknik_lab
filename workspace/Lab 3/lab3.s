...
setup:
	move.l #$7000,a7
	move.l #$0,$3000 	  ; Starttid 32-bitar, 00:00.
	jsr PIAINIT
	jsr setupMUX
...
BCD:
	...
	cmp.b #0,$10082		  ; laser fran PIAB —> nolstaller flaggor i CRB
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Adressraknare i d1. Pekar ut vilken data som ska användas ($900->$901->$902->$903->$900).  
;; De tre LSB i d1 styr mux-ingangar (00,01,10,11,00)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;


MUX:
	movem.l a0-a6/d0-d7,-(a7) ; Sparar register
	cmp.b #0,$10080		  ; laser fran PIAA —> nolstaller flaggor i CRA
...
PIAINIT:
	move.b #0,$10084	  ; DDRA
	move.b #$3f,$10080	  ; valj in/ut (a-7 anvands ej)
	move.b #$7,$10084	  ; PIAA och tillat avb da CRA7 1-satts (CA1 0->1)
	move.b #0,$10086	  ; DDRB
	move.b #$ff,$10082	  ; alla ut
	move.b #$7,$10084	  ; PIAB och tillat avb da CRA7 1-satts (CB1 0->1)
	rts
